...
class RAGModel:
    ...
    def calculate_embeddings(self, sentences):
        ...
        #       but sentence_model.encode_multi_process seems to interfere with Ray
    ...
    def batch_generate_answer(self, batch: Dict[str, Any]) -> List[str]:
        ...
        if self.use_transformers:
            return self.transformer_model.generate_response(
                prompts=queries, max_new_tokens=50, temperature=0.5, top_p=0.8
            )
        if self.is_server:
    ...
    def format_prompts(self, queries, query_times, batch_retrieval_results=[]):
        ...
        system_prompt = (
            ...
            "not contain the necessary information to answer the question, respond with 'I don't know'."
        )
        formatted_prompts = []
