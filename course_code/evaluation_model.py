...
class EvaluationModel:
    def __init__(self, llm_name="meta-llama/Llama-3.2-3B-Instruct", is_server=False, vllm_server=None, max_retries=10, use_transformers=True):
        """
    ...
    def batch_generate_answer(self, batch: Dict[str, Any]) -> List[str]:
        ...
        if self.use_transformers:
            # Use TransformerModel for batch generation
